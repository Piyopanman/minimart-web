...
function listProducts() {
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, graphqlClient_1.graphqlRequest({ query: listProductsQuery })];
                case 1:
                    data = _a.sent();
...
function getProduct(id) {
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, graphqlClient_1.graphqlRequest({ query: productQuery, variables: { id: id } })];
                case 1:
                    data = _a.sent();
